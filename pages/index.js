...
export default function Home() {
  ...
  const [bubbles, setbubbles] = useState([
    ...
    { txt: "Kenalin, gue Marcelino Oktaviansyah", show: false, delay: 3500 },
    {
      txt: "Saat ini, gue lagi merintis karir sebagai seorang programmer, khususnya di bidang web developer",
      show: false,
      delay: 8000,
    },
    {
  ...
  return (
    <div className="flex flex-col justify-center min-h-screen py-2 bg-gray-50">
      <Head>
        <title>Marcelino Oktaviansyah</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <h1 className="hidden">Marcelino Oktaviansyah</h1>
